...
public class TwitterOauthHelper {
    ...
    private static final String CONSUMER_KEY = "HwNakmdlmRnd5GX4fZx1zCaTW";
    private static final String CONSUMER_SECRET = "DpMRORtRE8Kk3glrFnzcTGPgZim0NTXg14l0rbnPSxIVdgjb2p";
    ...
    public String getAuthorizationHeaderString(Request request)
        ...
        newRequest();
        mRequestEndpoint = request.url().toString();
